...
USER_NAME = os.environ['USER_NAME'] # 'rycerzes'
...
if __name__ == '__main__':
    ...
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'rycerzes'
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # only calculate for user rycerzes
